// este es el esqueleto de todas las páginas, para no repetir código
// acá meto el head, los estilos, el menú y el pie de página
...
<head>
  ...
  <title>${titulo} - nodejs práctico</title>
...
<body>
  ...
  <footer class="footer-wrap container pb-4">
    <div class="footer-inner">
      ...
      <p class="footer-sub">proyecto node.js — módulos nativos y npm en acción.</p>
