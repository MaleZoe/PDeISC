...
export const CrearTareaPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validarFormulario()) {
      const nuevoId = agregarTarea(formulario);
      // Redirigir al detalle de la tarea recién creada
      navigate(`/tarea/${nuevoId}`);
    }
  };
        ...
        <div className="col-12 col-md-8 col-lg-6">
          ...
          <div className="card card-premium">
            <div className="card-header bg-transparent border-0 pt-4 px-4 pb-0">
              <h2 className="mb-0 fw-bold">Crear Nueva Tarea</h2>
              <p className="text-body-secondary mt-2 mb-0">Completa los campos para añadir una nueva tarea a tu lista.</p>
            </div>
            ...
            <div className="card-body p-4">
              <form onSubmit={handleSubmit} noValidate>
                ...
                <div className="d-flex flex-column-reverse flex-sm-row justify-content-end gap-3">
                  <button type="button" className="btn btn-light px-4 rounded-pill" onClick={() => navigate('/')}>
                    Cancelar
                  </button>
                  <button type="submit" className="btn btn-primary px-4 shadow-sm rounded-pill d-flex align-items-center justify-content-center gap-2">
                    <i className="bi bi-save"></i> Guardar tarea
                  </button>
                </div>
