...
export const DetalleTareaPage = () => {
  ...
  const { tareas, cambiarEstadoTarea, eliminarTarea } = useTareas();
  ...
  const handleToggleEstado = () => setModalAction('toggle');
          ...
          <div className="d-flex flex-column flex-sm-row justify-content-between align-items-sm-center gap-3 mt-4">
            ...
            <div className="d-flex flex-wrap justify-content-end gap-2">
              <button 
                ...
                className="btn btn-outline-danger shadow-sm rounded-pill px-4 d-flex align-items-center justify-content-center gap-2"
              >
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content card-premium border-0 shadow-lg">
              ...
              <div className="modal-footer border-0 pt-0 d-flex justify-content-center gap-2">
                <button type="button" className="btn btn-light rounded-pill px-4" onClick={() => setModalAction(null)}>
                  Cancelar
                </button>
                <button 
                  type="button" 
