# Explicación Técnica - Ejercicio 7 (Método indexOf)

Este proyecto académico implementa el método `indexOf()` de JavaScript de manera modular y estructurada bajo el estándar de Express y ESM (import).

## Estructura del Proyecto
- `server.js`: Servidor Express corriendo en el puerto 3007. Valida las entradas en el Backend antes de modificar el estado.
